    ...
    <div class="container-fluid">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <button href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" data-bs-toggle="modal"
                data-bs-target="#adicionar"><i class="bi bi-person-plus"></i> Novo tipo de viatura</button>
        </div>
        <div class="row">
                        ...
                        <tbody>
                            @foreach ($tipo as $tipos)
                                <tr>
                                    ...
                                    <td>{{ $tipos->data }}</td>
                                    <td>
                                        <a href="#" id="btnEditar" class="btn btn-primary btnEditar"><i
                                                class="bi bi-pencil-square"></i></a>
                                        <a href="#" class="btn btn-danger btnEliminar"><i
...
@push('javascript')
    <script src="{{ asset('js/TipoViatura.js') }}"></script>
@endpush
